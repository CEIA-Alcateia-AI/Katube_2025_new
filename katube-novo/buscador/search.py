...
def search_videos(api_key, content_id, output_folderpath, output_result_file):
    ...
    # Set default base type for channel scanning
    base_type = getattr(Config, 'orig_base', 'channel')
    #print('Searching videos from {} - {}...'.format(base_type, content_id))
    path_dest = join(output_folderpath, base_type, content_id )
